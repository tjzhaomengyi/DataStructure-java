package com.MCAAlgorithm.bigshua.class01;
...
public class Code06_AOE {
	...
	public static int minAoe3(int[] x, int[] hp, int range) {
		...
		for (int i = 0; i < N; i++) {
			...
			best[i + 1] = trigger;//确定能覆盖住距离的处罚点，让i在trigger的左边，然后triger正好可以覆盖住i，同样best不要0位置，所以每次加1
		}
	...
	public static class SegmentTree {
		...
		// L..R -> 任务范围 ,所有的值累加上C
		// l,r -> 表达的范围
		// rt 去哪找l，r范围上的信息，开始的时候就是rt=1，l=1，r=n，rt可以把所有范围的点都扎到
