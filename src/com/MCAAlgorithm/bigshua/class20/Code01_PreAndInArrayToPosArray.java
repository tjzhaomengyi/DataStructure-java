...
import com.mikemyzhao.TreeOperations_2.bigshua.traverse.PreAndInOrderToPostOrder_20;
...
public class Code01_PreAndInArrayToPosArray {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < testTime; i++) {
			...
			int[] MyAns = PreAndInOrderToPostOrder_20.getPostOrder(pre, in);
			if (!isEqual(pos, ans1) || !isEqual(ans1, ans2) || !isEqual(pos, classAns) || !isEqual(pos, MyAns)) {
