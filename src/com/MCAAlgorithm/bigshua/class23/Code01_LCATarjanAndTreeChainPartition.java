package com.MCAAlgorithm.bigshua.class23;

import com.mikemyzhao.TreeClassicSytle.TarjanAndLowestCommonAncestor.LowestCommonAncestorAndTarjan_23;
...
public class Code01_LCATarjanAndTreeChainPartition {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < testTime; i++) {
			...
			int[] ans4 = LowestCommonAncestorAndTarjan_23.query2(father, queries);
			...
			System.out.println();
			if (!equal(ans1, ans2) || !equal(ans1, ans4)) {
