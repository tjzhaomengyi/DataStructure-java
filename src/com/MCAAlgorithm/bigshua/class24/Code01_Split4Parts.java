package com.MCAAlgorithm.bigshua.class24;

import com.mikemyzhao.SomeSkills_0.SumAndPreSum_0.Split4Parts_24;
...
public class Code01_Split4Parts {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < testTime; i++) {
			...
			if (canSplits1(arr) & canSplits2(arr) & Split4Parts_24.canSplit(arr)) {
