...
public class Code03_SortedSubsequenceMaxSum {
	...
	// 正式方法：这个思路不太好想
	// 时间复杂度O(N * logN)
	//根据身高建立线段树，1，2，3，4，5，6；第一个人3，100，直接加入线段树，第二个人2，200，直接进入线段树；第三个人3，50，可以用第二个人垫一下3，250；
	//1，0       1,0		1,0      1,0
	//2,0		2,0			2,200    2,200
	//3,0		3,100		3,100    3,200+50（踩2）
	//线段树是遍历到目前节点为止（或者说以当前节点为最终节点），不降序子序列的最大得分，最后为了求最大值把线段树撸一遍就行了
